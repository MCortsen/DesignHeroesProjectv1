...
namespace yeetles_13
{
    public partial class CreateProjectPage : System.Web.UI.Page
    {
        ...
        {
            Database.CreateProject(TitleTextBox.Text, DescriptionTextArea.Value, StartDateTextBox.Value.ToString(), EndDateTextBox.Value.ToString(), Convert.ToDouble(EstimatedHoursTextBox.Text), 0, ClientTextBox.Text, Convert.ToInt32(CvrTextBox.Text), ProjectLeadDropDown.SelectedValue);
            Response.Redirect("Dashboard.aspx");
        }
